...
static const struct excel_info PartInfo_Private[PART_NUM]={			{"preloader",262144,0x0, EMMC, 0,EMMC_PART_BOOT1},
			...
			{"android",3221225472,0x5d00000, EMMC, 5,EMMC_PART_USER},
			{"cache",1073741824,0xc5d00000, EMMC, 6,EMMC_PART_USER},
			{"usrdata",2147483648,0x105d00000, EMMC, 7,EMMC_PART_USER},
